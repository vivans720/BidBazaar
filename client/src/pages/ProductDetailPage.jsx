                ...
                <div className="bg-white rounded-xl shadow-md overflow-hidden p-6">
                  ...
                  <div className="bg-purple-50 rounded-lg p-4 flex">
                    ...
                    <p className="text-purple-700 text-sm">
                      As an administrator, you can view but cannot place bids on
                      auctions. This ensures fairness and transparency in the
                      bidding process.
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-xl shadow-md overflow-hidden p-6">
                  ...
                  <div className="bg-orange-50 rounded-lg p-4 flex">
                    ...
                    <p className="text-orange-700 text-sm">
                      As a vendor, you can view but cannot place bids on
                      auctions. This ensures fair competition and prevents
                  ...
                  {product.status === "pending" && (
                    <div className="bg-yellow-50 rounded-lg p-4 flex">
                      ...
                      <p className="text-yellow-700 text-sm">
                        This auction is pending approval and not yet active for
                        bidding.
                      </p>
                    </div>
                  )}
                  {product.status === "rejected" && (
                    <div className="bg-red-50 rounded-lg p-4 flex">
                      ...
                      <p className="text-red-700 text-sm">
                        This auction has been rejected and is not available for
                        bidding.
                      </p>
                    </div>
                  )}
