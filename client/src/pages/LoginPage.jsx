    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex flex-col lg:flex-row">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary-600 to-primary-800 text-white p-12 flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-xl mb-6">Sign in to your BidBazaar account to continue your bidding journey. Access your dashboard, track your bids, and discover new items.</p>
        ...
        <div className="relative z-10">
          <p className="text-white text-opacity-80 italic">
            "I've been using BidBazaar for over a year now, and it's been a fantastic experience. The platform is intuitive and the bidding process is exciting!"
          </p>
          <div className="mt-4 flex items-center">
            ...
            <div className="ml-3">
              ...
              <p className="text-sm text-white text-opacity-70">Happy User</p>
            </div>
          </div>
        </div>
      </div>
